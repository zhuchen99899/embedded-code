...
extern SemaphoreHandle_t BinarySemaphore_WIFI_PIDSET;//MQTT SUBSCRIBE报文二值信号量句柄
extern SemaphoreHandle_t BinarySemaphore_WIFI_TEMSET;//MQTT SUBSCRIBE报文二值信号量句柄
/**************二值信号量创建****************/
